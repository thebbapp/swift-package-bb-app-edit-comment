...
let package = Package(
    name: "BbAppEditComment",
    defaultLocalization: "en",
    platforms: [.iOS("18.5"), .macOS("15.5"), .tvOS("18.0")],
    products: [.library(name: "BbAppEditComment", targets: ["BbAppEditComment"])],
    dependencies: [
        .package(
    ...
    targets: [
        .binaryTarget(
            name: "BbAppEditComment",
            url:
                "https://github.com/thebbapp/swift-package-bb-app-edit-comment/releases/download/v0.1.0/BbAppEditComment.xcframework.zip",
            checksum: "7c4943ec51e35cfdd30f984ded4d262c3771e53ab4d4c34bc7a9cb46bc6e775c"
        )
    ],
